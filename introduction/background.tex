...
In Chapter 6 we propose a novel approach for class integration test generation.
...
The approach introduced in Chapter 6 performs white-box testing. It monitors the interaction between the target classes and strives to cover different integration scenarios between them.

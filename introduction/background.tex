...
\paragraph{Search-based approaches for integration testing.}
...
\paragraph{Search-based approaches for other testing levels.}
...
In this thesis, we identified the challenges in search-based crash reproduction by performing an empirical evaluation (Chapter X). Then, we introduced novel solutions to tackle the detected challenges and improve the effectiveness and efficiency of the crash reproduction search process (Chapters Y o Z).